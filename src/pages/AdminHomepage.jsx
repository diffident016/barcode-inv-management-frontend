...
function AdminHomepage() {
    ...
    const [orders, setOrders] = useReducer((prev, next) => {
        return { ...prev, ...next }
    },
        {
            fetchState: 0,
    ...
    const [customers, setCustomers] = useReducer((prev, next) => {
        return { ...prev, ...next }
    },
        {
            fetchState: 0,
    ...
    const [sales, setSales] = useReducer((prev, next) => {
        return { ...prev, ...next }
    },
        {
            fetchState: 0,
    ...
    const fetchOrders = () => {
        ...
        getAllOrder(STORE.storeID).then((response) => response.json())
            .then((data) => {
                if (!data) return null;
