                ...
                <div className='flex-1 flex items-center justify-center h-full w-full '>
                    <div className='flex flex-col items-center border rounded-lg shadow-sm pt-10 w-[450px] h-[500px]'>
                        ...
                        <div className='z-10 pt-8 flex flex-col w-[500px] h-full items-center'>
                            <form onSubmit={handleSubmit} className='flex flex-col z-10 w-[350px] py-2 font-lato-bold text-[#1F2F3D]'>
                                ...
                                <button type='submit' className='mt-8 flex w-full h-10 bg-[#ffc100] rounded-lg justify-center items-center'>
